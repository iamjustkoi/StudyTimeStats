...
"}")
        ...
        self.gridLayout_3.addWidget(self.dragHandle, 0, 5, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.titleColorButton, 0, 3, 1, 1)
        ...
        self.directionFrame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.directionFrame.setFrameShadow(QtWidgets.QFrame.Plain)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../img/vert_lines.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.directionVerticalButton.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../img/horiz_lines.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.directionHorizontalButton.setIcon(icon3)
        ...
        self.startDayDropdown.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../img/remove_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../img/code_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.codeButton.setIcon(icon5)
        ...
        self.rangeDropdown.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.customRangeSpinbox.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.gridLayout_3.addWidget(self.expandFrame, 1, 0, 1, 6)
        ...
        self.titleLabel.setStyleSheet("#mainFrame {\n"
"    background: rgba(163, 163, 163, 5%);\n"
"    border-radius: 6px;\n"
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../img/chevron_down.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.expandoButton.setIcon(icon6)
        self.expandoButton.setIconSize(QtCore.QSize(20, 20))
        self.expandoButton.setObjectName("expandoButton")
        self.gridLayout_3.addWidget(self.expandoButton, 0, 4, 1, 1)
        self.titleLineEdit = QtWidgets.QLineEdit(self.mainFrame)
        self.titleLineEdit.setObjectName("titleLineEdit")
        self.gridLayout_3.addWidget(self.titleLineEdit, 0, 1, 1, 2)

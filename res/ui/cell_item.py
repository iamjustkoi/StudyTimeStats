...
"}")
        ...
        self.gridLayout.addWidget(self.rangeLabel, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.codeButton, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.directionLabel, 7, 0, 1, 1)
        ...
        self.startDayDropdown.addItem("")
        self.startDayDropdown.addItem("")
        self.gridLayout.addWidget(self.startDayDropdown, 5, 1, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.startDayLabel, 5, 0, 1, 1)
...
"}")
        ...
        self.codeTextEdit = QtWidgets.QPlainTextEdit(self.mainFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.codeTextEdit, 8, 0, 1, 5)
        self.directionFrame = QtWidgets.QFrame(self.mainFrame)
        ...
        self.gridLayout.addWidget(self.directionFrame, 7, 1, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../img/vert_grip.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dragHandle.setIcon(icon5)
        self.dragHandle.setObjectName("dragHandle")
        self.gridLayout.addWidget(self.dragHandle, 2, 4, 1, 1)
...
from .forms import DragHandle, HoverButton

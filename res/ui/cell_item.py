...
"}")
        ...
        self.gridLayout.addWidget(self.codeButton, 6, 4, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.codeTextEdit, 7, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.directionFrame, 6, 1, 1, 1)
        ...
        self.dragHandle.setStyleSheet("background-color: transparent;")
        icon5 = QtGui.QIcon()
        ...
        self.gridLayout.addWidget(self.dragHandle, 1, 4, 4, 1)

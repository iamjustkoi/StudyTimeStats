...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.checkBox = QtWidgets.QCheckBox(self.decks_tab)
...
"This window can also be opened in the Add-ons menu using the Config button."))
        ...
        self.checkBox.setToolTip(_translate("OptionsDialog", "Shows an \"hour.min\" format, versus an \"hh:mm\" format, for all time output values."))
        self.checkBox.setText(_translate("OptionsDialog", "Use decimal format time outputs"))

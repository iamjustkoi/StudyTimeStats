...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.rowListWidget.setMinimumSize(QtCore.QSize(0, 64))
        ...
        self.rowListWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
    ...
    def retranslateUi(self, OptionsDialog):
        ...
        self.rowListWidget.setSortingEnabled(True)

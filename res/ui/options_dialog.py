...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.mainViewGroupbox = QtWidgets.QGroupBox(self.appearance_tab)
        ...
        self.mainViewGroupbox.setStyleSheet("b")
        ...
        self.rowListWidget = QtWidgets.QListWidget(self.mainViewGroupbox)
        ...
        self.rowListWidget.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.rowListWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.rowListWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.rowListWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.rowListWidget.setProperty("showDropIndicator", False)
        self.rowListWidget.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.rowListWidget.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.rowListWidget.setObjectName("rowListWidget")
        self.verticalLayout_5.addWidget(self.rowListWidget)
        spacerItem = QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_5.addItem(spacerItem)
        self.general_layout.addWidget(self.mainViewGroupbox)
        ...
        self.about_scroll.setGeometry(QtCore.QRect(0, 0, 455, 851))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)

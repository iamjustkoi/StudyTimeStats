...
class Ui_OptionsDialog(object):
    def setupUi(self, OptionsDialog):
        ...
        self.total_text_line = QtWidgets.QLineEdit(self.decks_tab)
        self.total_text_line.setObjectName("total_text_line")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.total_text_line)
        self.total_text_label = QtWidgets.QLabel(self.decks_tab)
        self.total_text_label.setObjectName("total_text_label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.total_text_label)
        self.range_text_label = QtWidgets.QLabel(self.decks_tab)
        self.range_text_label.setObjectName("range_text_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.range_text_label)
        self.range_text_line = QtWidgets.QLineEdit(self.decks_tab)
        self.range_text_line.setObjectName("range_text_line")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.range_text_line)
...
"This window can also be opened in the Add-ons menu using the Config button."))
        ...
        self.total_text_line.setToolTip(_translate("OptionsDialog", "Controls the formatting and statistics the total text should use.\n"
"See: About -> Text Macros"))
        self.total_text_label.setText(_translate("OptionsDialog", "Total Text Output"))
        self.range_text_label.setText(_translate("OptionsDialog", "Range Text Output"))
        self.range_text_line.setToolTip(_translate("OptionsDialog", "Controls the formatting and statistics the range text should use.\n"
"See: About -> Text Macros"))
